...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('cliente.index')}}"><i class="fa fa-dashboard"></i> Clientes</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{route('cliente.store')}}" enctype="multipart/form-data" via-cep-form>
                    {{ csrf_field() }}
                    <div class="box-body">                        
                        <div class="form-group">
                            <label for="nome">Nome</label>
                            <input type="text" class="form-control" id="nome" name="nome" placeholder="Entre com o nome do cliente"/>
                        </div>
                        <div class="form-group">
